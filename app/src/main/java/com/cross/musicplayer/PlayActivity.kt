...
class PlayActivity : AppCompatActivity() {
    ...
    private var addBtn1WasTap = false
    private var addBtn2WasTap = false
            ...
            object : SeekBar.OnSeekBarChangeListener {
                override fun onProgressChanged(
                    ...
                    if (fromUser) {
                        ...
                        findViewById<TextView>(R.id.fadeValue).text = progress.toString()
                    }
                }
